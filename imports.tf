...
# The win11-vdi answer-file ISO is generated by scripts/windows-vdi/ and
# hand-placed the same way the install ISOs above are; same adoption reason.
import {
  to = module.homelab.proxmox_download_file.win11_answer_iso
  id = "${local.deployment.proxmox_node}/${try(local.deployment.datastore_iso, "local")}:iso/win11-vdi-answer.iso"
}
